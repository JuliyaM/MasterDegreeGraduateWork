...
const val LACK_TRAIN_SYSTEM = "Неэфективная система обучения исполнителей"
...
//developing
const val TERMINATION_OF_LIBRARY_SUPPORT = "Прекрашение поддрежки библиотек, использованных при разработке"
const val BAD_DEVELOPER_PERFORMANCE = "Низкая производительность исполнителей"
const val BIG_COUNT_BUGS_ON_TEST =
    "Высокая доля некорректно работающего функционала, обнаруженого при тестировании"
...
const val BAD_ALGORITHM_COMPLEXITY =
    "Неэфективная реализация алгоритмов, требующая покупки дополнительных вычислительных мощностей"
...
//planing
const val NO_RIGHT_HOLDERS_DIALOG = "Отсутсвие заключенных соглашений на использование собственности правообладателей"
...
const val BAD_TESTING_ENVIRONMENT = "Отсутсвие устройств, используемых пользователями"

//delivery
const val BAD_USER_ENVIRONMENT = "Неккоректная установка продукта на конфигурацию устройств пользователя"
...
const val BAD_HIGH_LOAD_REALISATION = "Отсуствие корректного использования алгоритмов работы при высоких нагрузках"
const val BAD_MULTI_THREADING = "Трудности многопоточной работы проудкта"
...
const val BAD_TECHNICAL_DEBT = "Игнорирование большых объемов технического долга продукта"
...
const val LACK_BUSINESS_EXPERT = "Отсутсвие бизнес-специалиста в команде, разбирающегося в данной сфере"
const val BAD_UPDATE_POLITICS = "Отсутсвие плана по регулярным обновлениям продукта"
...
//developing
const val BAD_ALGORITHM_PERFORMANCE = "Низкая эффктивность оптимизации алгоритмов под платформу пользователя"


//ui_ux
const val HARD_UX_NO_HELP = "Высокая сложность работы продукта и отсутсвие инструкций по его использованию"
